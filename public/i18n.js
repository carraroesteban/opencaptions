...
const DICTS = {
  en: {
    ...
    '. Abrila por': '. Open it over', 'o en': 'or on', '(ver docs/EVENT-DAY.md → HTTPS).': '(see docs/EVENT-DAY.md → HTTPS).',
    ...
    '⚠ El micrófono solo funciona en': '⚠ The microphone only works on', '. Abrí esta página como https://… (ver docs/EVENT-DAY.md).': '. Open this page as https://… (see docs/EVENT-DAY.md).',
...
const PATTERNS = {
  en: [
    ...
    [/^Entrada (\d+)$/, 'Input $1'], [/ · Producción$/, ' · Production'], [/^Transcripción$/, 'Transcript'],
  ],
};
